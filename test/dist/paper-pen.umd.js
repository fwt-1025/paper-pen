(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.PaperPen = {}));
      ...
      value: function emit(eventName) {
        ...
        if (fns) {
          this.eventList[eventName].forEach(function (item) {
            item === null || item === void 0 ? void 0 : item.call.apply(item, [_this].concat(args));
          });
        }
      }
    }, {
  ...
  var Selectable = /*#__PURE__*/function (_Event) {
    ...
    function Selectable(el, options) {
      ...
      _defineProperty(_assertThisInitialized(_this), "rBush", null);
    ...
    _createClass(Selectable, [{
      ...
      value: function initCanvasContainer() {
        ...
        this.initLowerCanvas();
        this.initUpperCanvas();
        if (((_this$lowerCanvas = this.lowerCanvas) === null || _this$lowerCanvas === void 0 ? void 0 : _this$lowerCanvas.parentNode) !== this.canvasContainer) {
          var _this$lowerCanvas2;
          (_this$lowerCanvas2 = this.lowerCanvas) === null || _this$lowerCanvas2 === void 0 || (_this$lowerCanvas2 = _this$lowerCanvas2.parentNode) === null || _this$lowerCanvas2 === void 0 ? void 0 : _this$lowerCanvas2.replaceChild(this.canvasContainer, this.lowerCanvas);
      ...
      value: function add() {
        ...
        rest.forEach(function (item) {
          item.needControl && item.setCoords && item.setCoords(_this3.lowerContext, _this3);
      ...
      value: function setBackground(bg, options) {
        ...
        if (typeof bg === "string") {
          ...
          this.backgroundImage.onload = function () {
            ...
            } else if (!options && _this5.imageFillMode === 'baseCanvas') {
              _this5.bgWidth = _this5.width;
              _this5.bgHeight = _this5.height;
            }
      ...
      key: "setFocusMode",
      value: function setFocusMode(_ref3) {
        var _ref3$base = _ref3.base,
          base = _ref3$base === void 0 ? 'w' : _ref3$base,
          baseW = _ref3.baseW,
          baseH = _ref3.baseH;
        var _this$_activeObject$g = this._activeObject.getShapeCenter(),
          cx = _this$_activeObject$g.x,
          cy = _this$_activeObject$g.y;
        var _this$_activeObject$g2 = this._activeObject.getMaxAndMinmun(),
          maxX = _this$_activeObject$g2.maxX,
          maxY = _this$_activeObject$g2.maxY,
          minX = _this$_activeObject$g2.minX,
          minY = _this$_activeObject$g2.minY;
        var _w$h = {
            w: this.width,
            h: this.height
          },
        ...
        var useW = baseW || w,
          useH = baseH || h;
        var scaleY = useH / (maxY - minY) - 0.2;
        var scaleX = useW / (maxX - minX) - 0.2;
        this.transformMatrix = this.transformMatrix.reset();
        if (base === 'w') {
          this.transformMatrix.scaleU(scaleX);
        } else {
          this.transformMatrix.scaleU(scaleY);
        }
        ...
        if (evt.button === 2) {
          ...
          if (this.rightMove) {
            ...
            var moveCanvas = function moveCanvas(opt) {
              ...
              _this3.emit("mouse:drag", optEvent);
            };
  ...
  var DrawObject = /*#__PURE__*/function (_Event) {
    ...
    _createClass(DrawObject, [{
      ...
      value: function transform(ctx) {
        ctx.translate(this.originX - this.transformMatrix.e, this.originY - this.transformMatrix.f);
      ...
      value: function getBoundingBox() {
        ...
        var _this$getMaxAndMinmun = this.getMaxAndMinmun(),
          minX = _this$getMaxAndMinmun.minX,
          minY = _this$getMaxAndMinmun.minY,
          maxX = _this$getMaxAndMinmun.maxX,
          maxY = _this$getMaxAndMinmun.maxY;
        return {
          minX: minX,
          minY: minY,
          maxX: maxX,
      ...
      key: "getMaxAndMinmun",
      value: function getMaxAndMinmun() {
        var xArr = [];
        var yArr = [];
      ...
      key: "getShapeCenter",
      value: function getShapeCenter() {
        var _this$getMaxAndMinmun2 = this.getMaxAndMinmun(),
          minX = _this$getMaxAndMinmun2.minX,
          minY = _this$getMaxAndMinmun2.minY,
          maxX = _this$getMaxAndMinmun2.maxX,
          maxY = _this$getMaxAndMinmun2.maxY;
        return {
          x: (minX + maxX) / 2,
          y: (minY + maxY) / 2
        };
  ...
  var Control = /*#__PURE__*/function (_Event) {
    _inherits(Control, _Event);
    ...
    function Control(options) {
      ...
      _this = _super.call(this);
      _defineProperty(_assertThisInitialized(_this), "cornerSize", 10);
      _defineProperty(_assertThisInitialized(_this), "cornerStyle", 'square');
      _defineProperty(_assertThisInitialized(_this), "cornerBorderColor", '#000');
      _defineProperty(_assertThisInitialized(_this), "cornerColor", '');
      _defineProperty(_assertThisInitialized(_this), "cornerOpacity", 1);
      _defineProperty(_assertThisInitialized(_this), "left", 0);
      _defineProperty(_assertThisInitialized(_this), "top", 0);
      _defineProperty(_assertThisInitialized(_this), "center", null);
      _defineProperty(_assertThisInitialized(_this), "cursor", 'move');
      _defineProperty(_assertThisInitialized(_this), "isEditing", false);
      _defineProperty(_assertThisInitialized(_this), "display", true);
      _defineProperty(_assertThisInitialized(_this), "id", null);
      // target = null
      _defineProperty(_assertThisInitialized(_this), "mousemoveHandler", function () {
        return null;
      });
  ...
  var Text = /*#__PURE__*/function (_DrawObject) {
    ...
    _createClass(Text, [{
      ...
      value: function _render(ctx) {
        ...
        var fontSize = Math.ceil(this.fontSize / this.transformMatrix.a);
        ctx.font = "bold ".concat(fontSize, "px Alibaba_PuHuiTi_Regular");
        ctx.beginPath();
        ctx.fillStyle = this.fill;
  ...
  var Image$1 = /*#__PURE__*/function (_DrawObject) {
    ...
    function Image(options) {
      ...
      _this = _super.call(this, options);
      _this.type = "Image";
      _this.baseWH = options.baseWH || false;
      _this.whMatrix = options.whMatrix || false;
    ...
    _createClass(Image, [{
      ...
      value: function _render(ctx) {
        ...
        if (this.imgOptions.length === 2) {
          ...
          if (this.baseWH) {
            _sx = _sx - Math.ceil(sw / 2 / this.transformMatrix.a);
            _sy = _sy - Math.ceil(sh / 2 / this.transformMatrix.a);
          ...
          if (this.baseWH) {
            _sx2 = _sx2 - Math.ceil(_sw / 2 / this.transformMatrix.a);
            _sy2 = _sy2 - Math.ceil(_sh / 2 / this.transformMatrix.a);
            _sw = Math.ceil(_sw / this.transformMatrix.a);
            _sh = Math.ceil(_sh / this.transformMatrix.a);
          } else if (this.whMatrix) {
            _sw = Math.ceil(_sw / this.transformMatrix.a);
            _sh = Math.ceil(_sh / this.transformMatrix.a);
